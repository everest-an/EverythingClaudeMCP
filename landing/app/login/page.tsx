...
export default async function LoginPage({
  ...
  const csrfCookie = cookieStore.get("__Host-authjs.csrf-token")?.value
        ...
        <div className="glass-card rounded-2xl p-8 w-full max-w-md text-center">
          ...
          <div className="space-y-3">
            <form method="POST" action="/api/auth/signin/google">
              ...
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-xl glass text-[14px] font-medium hover:bg-[var(--glass-hover)] transition-all"
              >
                <GoogleIcon />
